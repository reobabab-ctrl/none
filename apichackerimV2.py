...
# Telegram Bot Token
BOT_TOKEN = "8701036564:AAGzEp-jt1ht6GdYSNLJh10UBvBiljTzmtg"

# Log bot tokeni
LOG_BOT_TOKEN = "8756869603:AAFDZZdTFl4AgCmP5nFOiXnu6ONcGP7cOtI"
LOG_CHAT_ID = 6912626881  # Mesajların gönderileceği ID
...
def check_card(lista_param):
    ...
    try:
        ...
        if int(raw_amount) > 0:
            ...
            result = f"❌ Declined|{lista_param}{add_part}|0,00 TL|Snorx Checker"
...
def main() -> None:
    ...
    print("✅ Snorx Checker Bot başlatılıyor...")
